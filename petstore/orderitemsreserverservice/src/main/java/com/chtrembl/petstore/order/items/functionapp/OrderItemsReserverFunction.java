package com.chtrembl.petstore.order.items.functionapp;

import java.util.*;

import com.chtrembl.petstore.order.items.model.OrderItems;
...
public class OrderItemsReserverFunction {
    /**
     * This function listens at endpoint "/api/OrderItemsReserverFunction". Two ways to invoke it using "curl" command in bash:
     * 1. curl -d "HTTP Body" {your host}/api/OrderItemsReserverFunction
     * 2. curl {your host}/api/OrderItemsReserverFunction?name=HTTP%20Query
     */
